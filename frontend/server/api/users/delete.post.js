...
export default defineEventHandler(async (event) => {
  try {
    ...
    console.log('API: Deleting user with POST method:', userId);
    ...
    try {
      ...
      const settingsResult = db.prepare('DELETE FROM settings WHERE user_id = ?').run(userId);
      console.log('Deleted user settings records:', settingsResult.changes);
